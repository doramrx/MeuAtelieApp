...
import { OrderData } from "../../../screens/Orders";
                ...
                {props.orderType === "Tailored" ? (
                    <View>
                        ...
                        <Text style={styles.orderDueDate}>
                            {`${String(
                                props.orderItems[0].dueDate.getDate()
                            ).padStart(2, "0")}/${String(
                                props.orderItems[0].dueDate.getMonth() + 1
                            ).padStart(
                                2,
                                "0"
